// Enhanced Wellness Chat Implementation with Comprehensive Mental Health Support
document.addEventListener('DOMContentLoaded', function() {
    ...
    const responseDatabase = {
        ...
        depression: {
            ...
            tips: [
                "Reach out to a mental health professional - the counseling center offers free sessions for students.",
        ...
        anxiety: {
            ...
            resources: {
                ...
                resources: [
                    ...
                    'Anxiety Workbooks: Available at the Wellness Center',
        ...
        // Stress
        stress: {
            info: "Stress is your body's natural response to challenges. While some stress can motivate you, too much can affect your physical and mental health. College can be particularly stressful with academic demands, social changes, and future planning.",
            tips: [
            ...
            resources: {
                ...
                resources: [
                    ...
                    'Mindfulness Sessions: Daily drop-ins at the Wellness Center',
        ...
        trauma: {
            ...
            resources: {
                ...
                resources: [
                    ...
                    'Trauma Recovery Workbooks: Available at the Wellness Center',
        ...
        // Eating Disorders
        eatingdisorder: {
            info: "Eating disorders are serious mental health conditions characterized by irregular eating habits and distressing thoughts about food, weight, and body image. They're common among college students and require professional treatment.",
            tips: [
        ...
        sleep: {
            info: "Quality sleep is essential for learning, memory, and emotional wellbeing. Most college students need 7-9 hours of sleep per night. Sleep problems are common but can significantly impact academic performance and mental health.",
            tips: [
        ...
        exercise: {
            ...
            resources: {
                ...
                resources: [
                    ...
                    'Walking Trails: Maps available at the Wellness Center'
                ],
        ...
        general: {
            info: "Wellness encompasses multiple dimensions including physical, mental, social, and academic health. Each aspect affects the others, creating a holistic picture of wellbeing.",
            tips: [
                ...
                "Connect with others who share your wellness goals for mutual support.",
                "Regularly check in with yourself about what's working and what isn't.",
                "Utilize the many student wellness resources available on campus."
            ],
            resources: {
                title: 'Wellness Resources',
                content: 'These resources support overall student wellbeing:',
                resources: [
                    'Wellness Center: Hub for health and wellbeing services',
                    'Counseling Services: Free sessions for all students',
                    'Recreation Facilities: Gym, pool, courts, and more',
                    'Peer Wellness Coaching: One-on-one support',
                    'Wellness Workshops: Covering all dimensions of health'
                ],
                primaryAction: 'Schedule Wellness Assessment',
                secondaryAction: 'Explore All Resources'
            },
            followUp: [
                "Which aspect of wellness would you like to focus on today?",
                "What wellness goals are you currently working toward?",
                "Would you like to learn about the different dimensions of wellness?"
            ],
            suggestions: [
    ...
    const greetings = [
        ...
        "Hello! I'm here to help. What wellness topic would you like to discuss?",
        "Welcome! How can I assist with your wellbeing today?",
        "Hi! What aspect of wellness are you interested in exploring?"
    ];
    
    // Thank you response variations
    const thankYouResponses = [
        "You're welcome! I'm happy I could help. Is there anything else you'd like to discuss?",
        "Glad I could assist! Let me know if you have any other questions about wellness.",
    ...
    function addWelcomeMessage() {
        ...
        welcomeMessage.innerHTML = `
            <h3 class="welcome-header">Welcome to Vivify's Wellness Assistant!</h3>
            <p>Hi there! I'm here to help you explore wellness resources, answer questions, and provide support with your wellness journey. You can ask me about:</p>
            <ul>
                <li>Mental health topics like stress, anxiety, depression, and more</li>
                <li>Fitness and workout recommendations</li>
                <li>Nutrition guidance for students</li>
                <li>Sleep improvement techniques</li>
                <li>Academic wellness and study strategies</li>
                <li>Social wellness and building connections</li>
            </ul>
...
if (crisisButton) {
    crisisButton.addEventListener('click', function() {
        addResourceMessage({
            ...
            content: 'If you\'re experiencing a mental health crisis or need immediate support, please reach out to one of these resources:',
            resources: [
...
if (resourcesButton) {
    resourcesButton.addEventListener('click', function() {
        addAssistantMessage("Here are some wellness resources that might be helpful. What specific area are you interested in?");
