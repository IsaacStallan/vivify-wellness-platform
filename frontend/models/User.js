...
const UserSchema = new mongoose.Schema({
    ...
    // performance baseline assessment data
    performanceBaseline: {
        scores: {
...
UserSchema.methods.calculateOverallperformanceScore = function() {
    if (this.performanceBaseline && this.performanceBaseline.scores) {
        const { physical, mental, nutrition, lifeSkills } = this.performanceBaseline.scores;
